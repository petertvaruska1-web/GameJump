  ...
  private howToHtml() {
    return `<h2>How to play</h2>
      ...
      <ul>
        ...
        <li><b>Angel</b> gives you wings and a sword: <kbd>Space</kbd> in the air beats the wings (hold it to glide), a click is a sword combo (two cuts, a spinning sweep, a cleave), <kbd>R</kbd> soars up on one great wingbeat, and in the air dives onto what you aim at · <b>Telekinesis</b> grabs and throws bots, canisters, plates and its own shells · <b>Lightning</b> chains bolts while held · <b>Gravity</b> throws a crushing well and lets you float · <b>Super Speed</b> runs blindingly fast, and its long trail of light burns every bot and every foot of the Warden it touches (a click dashes, with a long wait between dashes) · <b>Sonic Force</b> blasts a cone of raw force that throws everything in front of you back, and <kbd>R</kbd> booms all round you.</li>
