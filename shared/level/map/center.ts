...
export function buildCenter(b: LevelBuilder) {
  ...
  b.hint('grapple', 0, vy, v0 + 22, 8, 'Grapple: jump off the edge, aim at the green anchor and hold the right mouse button. Hold forward, then let go of the button (or press Space) as you swing up.');
  const v3y = vy + 1.5;
